...
$query_search = "SELECT recetas.nombre, recetas.idRecetas FROM recetas_favoritas INNER JOIN recetas ON recetas.idRecetas = recetas_favoritas.idReceta WHERE idUser ="
. $_GET['idUser'];
